interface HamburgerBarIconProps {
  className?: string;
  ariaLabel?: string;
}

const HamburgerBarIcon = ({
  className,
  ariaLabel = 'Email Icon',
}: HamburgerBarIconProps) => {
  return (
    <svg
      viewBox='0 -1 20 20'
      fill='currentColor'
